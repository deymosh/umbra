...
- [x] 03-03-PLAN.md — Disposition ledger: source-read verifications, architectural blockers, and device-pass entries
- [x] 03-04-PLAN.md — Extend the relay-coordinator test with the discovered-flag and per-relay-lock coverage three fixes never got
- [x] 03-05-PLAN.md — New relay-client test file covering both halves of the same-relay dial-race fix
- [x] 03-06-PLAN.md — The ten remaining injected-logger cleanup catches, plus the future-dated-events default and its feed wiring
...
- [x] 03-08-PLAN.md — Annotate the ten entries that stay, complete all 38 requirement rows, and run the phase gate
...
- [x] 04-01-PLAN.md — Tracer: Settings reads the Gradle versionName via BuildConfig, and the drifted version string resource is retired (VERS-01, VERS-02)

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 04-02-PLAN.md — Dated 0.1.0 changelog section with the milestone's hardening summary, plus a new release-readiness checklist recording the observed lint/test/R8-build/signing-secret results (REL-01, REL-02)
...
| 4. Version Consistency & v0.1.0 Release Prep | 1/3 | In Progress|  |
