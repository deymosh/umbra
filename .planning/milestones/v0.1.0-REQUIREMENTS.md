# Requirements Archive: v0.1.0 Hardening & First Public Release
...
- [ ] **REL-03**: Prepare the `v0.1.0` git tag locally, ready for the user to push and trigger `android-release.yml`'s signed build + GitHub Release — *deliberately descoped from Phase 4 by explicit user direction (2026-09-06): the tag is created as a separate, standalone action the user triggers themselves, not as part of phase or milestone completion. See `.planning/phases/04-version-consistency-v0-1-0-release-prep/04-03-SUMMARY.md`.*
...
| REL-03 | Phase 4 | Descoped (user decision 2026-09-06) |
